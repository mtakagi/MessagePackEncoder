...
class MapTests : XCTestCase {
    ...
    func testEncodeStringMap() {
        let encoder = MessagePackEncoder()
        let map : OrderedDictionary<String, String> = ["foo" : "hoge", "bar" : "fuga", "bazz" : "piyo"]
        let result = try! encoder.encode(map)

        XCTAssertEqual(result, Data([0x83, 0xa3, 0x66, 0x6f, 0x6f, 0xa4, 0x68, 0x6f, 0x67, 0x65, 0xa3, 0x62, 0x61, 0x72, 0xa4, 0x66, 0x75, 0x67, 0x61, 0xa4, 0x62, 0x61, 0x7a, 0x7a, 0xa4, 0x70, 0x69, 0x79, 0x6f]))
    }
